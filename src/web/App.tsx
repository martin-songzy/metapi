...
const ModelProbe = lazy(() => import('./pages/ModelProbe.js'));
...
export const sidebarGroups = [
  {
    ...
    items: [
      ...
      { to: '/model-probe', label: '模型可用性', icon: <svg className="sidebar-item-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75} d="M9 12l2 2 4-4M4 6a2 2 0 012-2h12a2 2 0 012 2v12a2 2 0 01-2 2H6a2 2 0 01-2-2V6z" /></svg> },
          ...
          <PageTransition>
            <Suspense fallback={<RouteLoadingFallback />}>
              <Routes>
                ...
                <Route path="/model-probe" element={<ModelProbe />} />
